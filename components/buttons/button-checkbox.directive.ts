import { Directive, HostBinding, HostListener, Input, OnInit, Self } from '@angular/core';
...
export class ButtonCheckboxDirective implements ControlValueAccessor, OnInit {
    ...
    public onClick(): void {
        ...
        this.model.viewToModelUpdate(this.value);
    }

    public constructor(@Self() model: NgModel) {
        this.model = model;
        // hack !
